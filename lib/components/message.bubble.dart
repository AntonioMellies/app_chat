...
class MessageBubble extends StatelessWidget {
  static const _dafaultImage = 'assets/images/avatar.png';
  ...
  _showUserImage(String imageUrl) {
    ImageProvider? provider;
    final uri = Uri.parse(imageUrl);

    if (uri.path.contains(_dafaultImage)) {
      provider = const AssetImage(_dafaultImage);
